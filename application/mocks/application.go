...
import (
	...
	application "github.com/georgetonjr/arquitetura-hexagonal/application"
...
func (m *MockProductServiceInterface) GetProducts(id string) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
func (mr *MockProductServiceInterfaceMockRecorder) GetProducts(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetProducts", reflect.TypeOf((*MockProductServiceInterface)(nil).GetProducts), id)
}
...
// Get mocks base method.
func (m *MockProductRepository) Get(id string) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Save mocks base method.
func (m *MockProductRepository) Save(product application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", product)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
