...
import (
	"fmt"
	"github.com/georgetonjr/arquitetura-hexagonal/adapters/cli"
	mock_application "github.com/georgetonjr/arquitetura-hexagonal/application/mocks"
...
func testRun(t *testing.T) {
	...
	service.EXPECT().GetProducts(productId).Return(productMock, nil).AnyTimes()
